...
- mouse reporting 有効中は terminal ネイティブのマウス選択が奪われるが、**Shift+ドラッグは terminal 側選択として素通しされる**慣習に乗る(help / ドキュメントに明記)
...
SPEC-0001(mouse を deferred から v0.2 帯へ、clipboard 挙動の明記)、SPEC-0003(SGR mouse decode、Shift+ドラッグ素通し)を本 ADR に合わせて更新する。
