...
pub enum EditorAction {
    ...
    FileSaveAs,
    ViewToggleWrap,
    ViewToggleWhitespace,
    EditorToggleIndentStyle,
    EditorSetIndentWidth,
    PaletteOpen,
    GoToLine,
    AppQuit,
    InspectorOpen,
...
impl EditorAction {
    ...
    pub const ALL: &[Self] = &[
        ...
        Self::FileSaveAs,
        Self::ViewToggleWrap,
        Self::ViewToggleWhitespace,
        Self::EditorToggleIndentStyle,
        Self::EditorSetIndentWidth,
        Self::PaletteOpen,
        Self::GoToLine,
        Self::AppQuit,
        Self::InspectorOpen,
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ViewToggleWhitespace => "view.toggleWhitespace",
            Self::EditorToggleIndentStyle => "editor.toggleIndentStyle",
            Self::EditorSetIndentWidth => "editor.setIndentWidth",
            Self::PaletteOpen => "palette.open",
            Self::GoToLine => "cursor.goToLine",
...
impl FromStr for EditorAction {
    ...
    fn from_str(value: &str) -> Result<Self, Self::Err> {
        match value {
            ...
            "view.toggleWhitespace" => Ok(Self::ViewToggleWhitespace),
            "editor.toggleIndentStyle" => Ok(Self::EditorToggleIndentStyle),
            "editor.setIndentWidth" => Ok(Self::EditorSetIndentWidth),
            "palette.open" => Ok(Self::PaletteOpen),
            "cursor.goToLine" => Ok(Self::GoToLine),
